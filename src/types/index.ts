...
export const DOMAIN_CONFIG: Record<Domain, { label: string; labelKo: string; color: string; emoji: string }> = {
  output:       { label: 'Output',       labelKo: '만들기',  color: '#C0392B', emoji: '⚡' },
  input:        { label: 'Input',        labelKo: '배우기',  color: '#7D3C98', emoji: '📚' },
  system:       { label: 'System',       labelKo: '유지하기', color: '#6C7A89', emoji: '⚙️' },
  relation:     { label: 'Relation',     labelKo: '연결하기', color: '#D35400', emoji: '🤝' },
  monetization: { label: 'Monetization', labelKo: '벌기',    color: '#B7950B', emoji: '💰' },
  care:         { label: 'Care',         labelKo: '돌보기',  color: '#1E8449', emoji: '💛' },
